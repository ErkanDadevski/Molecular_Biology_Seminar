...
In Table \ref{tab:dnabert2-val-test} the results for the metrics discussed earlier for the validation and test set are presented. With an achieved accuracy of 0.87 and an ROC AUC of 0.9404.
%\begin{table}[h]
%    \centering
...
\newline
\subsection{CNN}
In Table \ref{tab:test_cnn} the results for the test set using the CNN model are presented. With an achieved accuracy of 0.87 and an ROC AUC of 0.9869.
\begin{table}[h]
    \centering
...
In Table \ref{tab:comparison} the results for all the different models are compared.
\begin{table}[!h]
    \centering
